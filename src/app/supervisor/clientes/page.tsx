...
export default async function ClientesPage() {
  ...
  const [
    ...
    supabaseAdmin()
      .from('clientes')
      .select('id, nombre_empresa, cuit, direccion, contacto_nombre, contacto_email, contacto_telefono, activo, frecuencia_ronda_minutos, aviso_ronda_minutos, planillas_habilitadas, latitud, longitud, created_at')
